...
st.divider()
st.write("This app uses machine learning for predicting house prices with given features of the house.For using this app you can enter the inputs from the UI and the use predict button.")
st.divider()
...
if predictbutton:
    ...
    st.write("Please enter predict after entering the values")
